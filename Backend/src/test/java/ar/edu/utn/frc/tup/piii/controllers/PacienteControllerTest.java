...
class PacienteControllerTest {
    ...
    void getAllPacientes() throws Exception{
        List<PacienteDto> pacientes = List.of(
                new PacienteDto(1L, "Test 1", "2020-03-03"),
                new PacienteDto(2L, "Test 2", "1990-05-02")
        );
        ...
        mockMvc.perform(get("/api/v1/pacientes")
                ...
                .andExpect(jsonPath("$[0].nombre_completo", is("Test 1")))
                .andExpect(jsonPath("$[1].nombre_completo", is("Test 2")));
