...
public partial class CriptomonedasDbContext : DbContext
{
    public CriptomonedasDbContext(DbContextOptions<CriptomonedasDbContext> options)
        : base(options)
    {
    }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Criptomoneda>(entity =>
        {
            ...
            entity.Navigation(e => e.CategoriaNavigation).AutoInclude();
        });
