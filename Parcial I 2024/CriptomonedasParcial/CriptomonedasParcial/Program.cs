...
using CriptoBack.Data.Repositories;
...
builder.Services.AddDbContext<CriptomonedasDbContext>(options => options.UseSqlServer(builder.Configuration.GetConnectionString("DefaultConnection")));
